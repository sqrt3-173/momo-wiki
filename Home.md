...
The shared institutional memory for Eli's businesses. Synced via git between the Mac mini
(MOMO), the MacBook (Obsidian), and — soon — NUNU. Read at session start; kept current as work
happens (see the [[skills/wiki-capture/SKILL|wiki-capture]] protocol).
