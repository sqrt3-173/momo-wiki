...
2. **Planning flow** — `new-project` + `plan-phase`. **✅ MACHINERY DONE (2026-07-02)** — awaiting first live run (gated on `confirm_roadmap`).
   ...
   - ⬜ Next: `confirm_plan` gate on work-dashboard phase 1 (first live plan-phase run, in flight 2026-07-02); then stage 3 (execution loop). Skip-bin is parked (Eli's call — gate open).
