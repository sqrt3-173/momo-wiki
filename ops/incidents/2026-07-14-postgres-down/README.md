...
self-heal by design (guard correctly blocks the tools needed). **286 ticks have now hit
this identical wall, spanning ~146 hours (2026-07-14 21:24 → present).** A second,
