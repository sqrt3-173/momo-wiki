...
self-heal by design (guard correctly blocks the tools needed). **234 ticks have now hit
this identical wall, spanning ~120 hours (2026-07-14 21:24 → present).** A second,
