...
self-heal by design (guard correctly blocks the tools needed). **283 ticks have now hit
this identical wall, spanning ~144.5 hours (2026-07-14 21:24 → present).** A second,
