...
self-heal by design (guard correctly blocks the tools needed). **372 ticks have now hit
this identical wall, spanning ~190 hours (2026-07-14 21:24 → present).** A second,
